...
Every client I work with becomes part of that same story—one built on faith, family, and a genuine care for people.`,
...

  {
    ...
    fullBio: `Christy is a devoted wife and mother of seven children and one daughter-in-love, whose heart for people shines through everything she does. Her care for others and attention to detail have naturally carried over into her real estate career, where she’s passionate about guiding families through every step of the buying or selling process.
...
// Pre-generate all agent paths (joe-duggar, christy-rainier, marcus-day)
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 md:px-6 md:py-16">
        <div className="flex flex-col gap-8 md:flex-row md:items-start">
          ...
          <div className="flex-1">
            ...
            <p className="mt-6 text-sm leading-relaxed text-neutral-200 whitespace-pre-line">
              {agent.fullBio}
            </p>
          </div>
        </div>
