  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <p className="text-gray-600">
        Have a question or want to schedule a showing? Send us a note and we’ll get back quickly.
      </p>
      <form className="space-y-3" onSubmit={submit}>
        ...
        <button className="rounded bg-brand-gold px-5 py-2 font-medium text-brand-black hover:bg-brand-goldDark" type="submit">
          Send
        </button>
      </form>
      ...
      <p className="text-xs text-gray-500">Emails are delivered via Resend. Set your RESEND_API_KEY & verified from-domain in Vercel env vars.</p>
    </div>
  );
}
