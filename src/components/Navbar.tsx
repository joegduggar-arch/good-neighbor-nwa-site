  ...
  return (
    <header className="border-b border-brand-gold/30 bg-brand-black text-white">
      <div className="mx-auto flex max-w-6xl items-center justify-between p-3 md:p-4">
        <Link href="/" className="flex items-center gap-3" aria-label="Good Neighbor Realty - Home">
          <Image src="/logo.png" alt="Good Neighbor Realty logo" width={120} height={120} priority />
