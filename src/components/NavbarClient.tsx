  ...
  return (
    <div ref={wrapperRef} className="sticky top-0 z-50 w-full bg-neutral-900/95 backdrop-blur supports-[backdrop-filter]:bg-neutral-900/75 border-b border-neutral-800">
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Desktop mega menu */}
        {open === "properties" && (
          <div role="menu" aria-label="Properties menu" className="hidden md:block border-t border-neutral-800">
                    ...
                    <li key={b.slug}>
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-xs text-neutral-400">Floorplans & current builds</div>
                        </div>
                      </Link>
                    </li>
                  ))}
            ...
            <div className="space-y-6 py-6">
              <div>
                ...
                <div className="mt-2 space-y-2 px-2">
                  <Link href={links.search} className="block rounded-lg bg-neutral-800 px-4 py-3 text-neutral-100">
                    Search Homes
                  </Link>
                  <Link href={links.propertiesLanding} className="block rounded-lg bg-neutral-800 px-4 py-3 text-neutral-100">
                    New Construction
                  </Link>
